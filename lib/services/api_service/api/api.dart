...
class Api {
  ...
  static Future<dynamic> registerToken() async {
    Map<String, dynamic> body = {};

    body['userId'] = await MySharedPreference.getUserId();
    body['token'] = await MySharedPreference.getFcmToken();

    try {
      var result = await restClient.registerFcmToken(body);
      return result;
    } catch (e) {
